...
#define KILLED_PROCESS1 2
#define KILLED_PROCESS2 5
#define KILLED_PROCESS3 7
...
{   
    ...
    if (rank == KILLED_PROCESS1 && count == 1) {
        raise(SIGKILL);
    }
    ...
    if (rank == KILLED_PROCESS2 && count == 2) {
        raise(SIGKILL);
    }
    ...
    if (rank == KILLED_PROCESS3 && count == 3) {
        raise(SIGKILL);
    }
